...
public class AppointmentSchedulingActivityAppoitmentsAdapter extends RecyclerView.Adapter<AppointmentSchedulingActivityAppoitmentsAdapter.AppointmentViewHolder> {
    ...
    public AppointmentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.appointment_scheduling_activity_appointment_item, parent, false);
    ...
    public static class AppointmentViewHolder extends RecyclerView.ViewHolder {
        ...
        public AppointmentViewHolder(View itemView) {
            ...
            patientName = itemView.findViewById(R.id.appointment_scheduling_activity_appointment_item_patient_name);
            patientAge = itemView.findViewById(R.id.appointment_scheduling_activity_appointment_item_patient_age);
            appointmentType = itemView.findViewById(R.id.appointment_scheduling_activity_appointment_item_appointment_type);
            appointmentDate = itemView.findViewById(R.id.appointment_scheduling_activity_appointment_item_appointment_date);
        }
    }
}
